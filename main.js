...
fs.ensureDir(path.join(process.env.PORTABLE_EXECUTABLE_DIR, 'YGOPro2_Updater'));
let obj1 = {
    ...
    token: '',
    filesstorePath: path.join(path.join(process.env.PORTABLE_EXECUTABLE_DIR, 'YGOPro2_Updater'), 'repo1.json')
};
let obj2 = {
    whereToFolder: process.env.PORTABLE_EXECUTABLE_DIR,
    filesObject: {},
    ...
    repository: 'ygopro2',
    token: '',
    filesstorePath: path.join(path.join(process.env.PORTABLE_EXECUTABLE_DIR, 'YGOPro2_Updater'), 'repo2.json'),
...
let obj3 = {
    ...
    token: '75f0491b1a091617ac1b7f4489b169cd2b398dbd',
    filesstorePath: path.join(path.join(process.env.PORTABLE_EXECUTABLE_DIR, 'YGOPro2_Updater'), 'repo3.json'),
...
let obj4 = {
    ...
    token: '75f0491b1a091617ac1b7f4489b169cd2b398dbd',
    filesstorePath: path.join(path.join(process.env.PORTABLE_EXECUTABLE_DIR, 'YGOPro2_Updater'), 'repo4.json'),
};
...
function downloadFromGitPath(objt, cb) {
    ...
    if (token === '75f0491b1a091617ac1b7f4489b169cd2b398dbd') {
